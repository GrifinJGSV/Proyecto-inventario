...
public class QuerysEmpleados {
    ...
    public static String ACTUALIZEmpleado = "UPDATE empleados SET nombre = ?, apellido = ?, identidad = ?, telefono = ?,"
            + " nombreEmergencia = ?, telefonoemergencia = ?, direccion = ?, estado = ? WHERE id = ?";
}
