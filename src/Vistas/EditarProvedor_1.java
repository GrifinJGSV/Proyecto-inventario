 ...
 * @author Josue
 */
public class EditarProvedor_1 extends javax.swing.JFrame {

    /**
     * Creates new form EditarProvedor
     */
    public EditarProvedor_1() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarProvedor_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarProvedor_1().setVisible(true);
            }
        });
    }
