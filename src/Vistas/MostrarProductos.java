...
public class MostrarProductos extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        if (tblMostrarProductos.getColumnModel().getColumnCount() > 0) {
            ...
            tblMostrarProductos.getColumnModel().getColumn(0).setHeaderValue("N#");
            tblMostrarProductos.getColumnModel().getColumn(1).setHeaderValue("Nombre del Producto");
            tblMostrarProductos.getColumnModel().getColumn(2).setHeaderValue("Tipo de inventario");
            tblMostrarProductos.getColumnModel().getColumn(3).setHeaderValue("Precio");
        }
        ...
        jButton1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Human Being\\Desktop\\Lupa.jpg")); // NOI18N
